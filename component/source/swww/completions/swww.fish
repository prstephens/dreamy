complete -c swww -n "__fish_use_subcommand" -s h -l help -d 'Print help information'
...
complete -c swww -n "__fish_seen_subcommand_from clear" -s h -l help -d 'Print help information'
...
complete -c swww -n "__fish_seen_subcommand_from img" -l transition-cord-x -d 'X cordinate to use as center for the transition' -r
complete -c swww -n "__fish_seen_subcommand_from img" -l transition-cord-y -d 'Y cordinate to use as center for the transition' -r
complete -c swww -n "__fish_seen_subcommand_from img" -l transition-speed-step -d 'value to increase the total speed by every frame' -r
complete -c swww -n "__fish_seen_subcommand_from img" -s h -l help -d 'Print help information'
...
complete -c swww -n "__fish_seen_subcommand_from init" -s h -l help -d 'Print help information'
complete -c swww -n "__fish_seen_subcommand_from kill" -s h -l help -d 'Print help information'
complete -c swww -n "__fish_seen_subcommand_from query" -s h -l help -d 'Print help information'
